...
# so the ollama image can trust the TLS-inspecting proxy when pulling models.
# Only needed on machines behind Zscaler. Safe to re-run; no-ops if none found.
#
# Usage: powershell -ExecutionPolicy Bypass -File infra/ingestion/setup-cert.ps1
